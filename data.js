...
const FESTIVAL_DATA = {
  ...
  // 焼津祭_2026.xlsx の「8月12日」「8月13日（往路）」「8月13日（復路）」シートをそのまま反映（本人希望により個人名・自宅名も含む）
  schedule: [
    {
      date: "8月12日(水)",
      items: [
  ...
  // 焼津祭_2026.xlsx の「地図」シートに記載の3地点（各地点のGoogleマップ共有リンクを含む）。
  mapPins: {
    title: "地図",
    points: [

...
const FESTIVAL_DATA = {
  ...
  roles: [
    { role: "人馬", people: "補助：クリス\nショウ、カツヨシ\nシンゴ、ヤスナリ\nコウスケ、ケタ\nソウヨウ、クリス\nキヨシさん、ベンさん" },
    { role: "荷物", people: "テツオ、ユウスケ" },
    { role: "保冷車", people: "ユウシ" },
    { role: "交通", people: "シンゴ、ヤスナリ、サトシ、コウさん" },
    { role: "両親お世話", people: "カワムラ" },
    { role: "うちわ、傘", people: "ケタ、タロウ" }
  ],
  ...
  schedule: [
    ...
    },
    {
      ...
      items: [
        ...
        { time: "05:15", title: "馬方は新港にお迎え\n※コウスケ、ケイスケ、ハセガワ\n※手綱、馬腹掛け、紅白座布団、紅白サラシ（一反ずつ）、バスタオル2枚、ハチマキ5枚、祝儀、水2L、スコップ、チリトリ、袋\n※新港を出るとき電話、電話来たら写真、片付け開始", place: "" },
        { time: "05:45", title: "挨拶、乾杯、中野家を出発\n※うちわ、傘、馬横（ショウ、クリス）\n※裏方さんは神社準備へ", place: "" },
    ...
    },
    {
      ...
      items: [
        ...
        { time: "20:00", title: "御神子神事の準備、焼津御旅所からコショウ（イス）を2つ新村宅へ持っていく", place: "" },
    ...
    sections: [
      {
        ...
        notes: [
          "3〜4人必要（前後2人、中継1〜2人）",
          "「前を通す」「後ろを通す」の合図を決めて全員で共有"
        ],
        signals: [
          {
            label: "前を通す",
            items: [
              "前の人：後ろに向かって赤旗を振る（またはライトを横向きに倒す）",
              "後ろの人：前に向かって白旗を振る（またはライトを縦に振る）"
            ]
          },
          {
            label: "後ろを通す",
            items: [
              "後ろの人：前に向かって赤旗を振る（またはライトを横向きに倒す）",
              "前の人：後ろに向かって白旗を振る（またはライトを縦に振る）"
            ]
          }
        ]
      }

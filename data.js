...
const FESTIVAL_DATA = {
  ...
  // 焼津祭_2026.xlsx の「地図」シートに記載の3地点（Googleマップリンクの座標を使用）。
  // 経路は表示せず、地点のピン留めのみ。
  mapPins: {
    title: "地図",
    points: [
      { label: "焼津神社", lat: 34.8650983, lng: 138.3137528 },
      { label: "ギャングスター", lat: 34.8643354, lng: 138.3143884 },
      { label: "丸久食品", lat: 34.85763, lng: 138.3230476 }
    ],
